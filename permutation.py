...
ASD = np.load('aveshort_ASD.npy')
NT = np.load('aveshort_NT.npy')
...
np.save('p_values_two_side_aveshort',np.array(p_values_two))
np.save('p_values_ADS_great_NT_aveshort',np.array(p_values_ADSgNT))
np.save('p_values_NT_great_ASD_aveshort',np.array(p_values_NTgADS))
...
p_values_two =  np.load('p_values_two_side_aveshort.npy')
diff_two = np.where(fdr(p_values_two)<0.05)
print(diff_two)

p_values_ADSgNT = np.load('p_values_ADS_great_NT_aveshort.npy')
diff_ADSgNT = np.where(fdr(p_values_ADSgNT)<0.05)
print(diff_ADSgNT)

p_values_NTgADS = np.load('p_values_NT_great_ASD_aveshort.npy')
diff_NTgADS = np.where(fdr(p_values_NTgADS)<0.05)
print(diff_NTgADS)


np.save('diff_two_side_aveshort',np.array(diff_two))
np.save('diff_ADS_great_NT_aveshort',np.array(diff_ADSgNT))
np.save('diff_NT_great_ASD_aveshort',np.array(diff_NTgADS))
...
diff_two =  np.load('diff_two_side_aveshort.npy')    
node_list_two = []
...
diff_ADS_great_NT =  np.load('diff_ADS_great_NT_aveshort.npy')    
...
diff_NT_great_ASD =  np.load('diff_NT_great_ASD_aveshort.npy')    
